...
# -----------------------------------------------------------------------------
# Walks the 13 ordered steps (00..12), one at a time, with verification gates.
...
run_interview() {
  ...
  MCP="$(ask 'Chrome MCP automation? (yes|no)' 'no')"
...
main() {
  ...
  echo "Definition of done: all 12 gates green (see WEBAPP-STACK-G1.0.md §10)."
}
