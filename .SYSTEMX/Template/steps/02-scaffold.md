...
- Confirm React 19 + Vite 7 baseline (default yes).
...
(pages: Home, About, Features, Contact, 404 + Navbar/Footer layout, router,
Firebase config, hosting/rules, CI). Use it instead of scaffolding by hand:
