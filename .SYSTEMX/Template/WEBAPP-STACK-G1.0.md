...
| Tool | Baseline | Why |
| --- | --- | --- |
| Vite | `^7` | Dev server + Rollup-based production build. |
...
| Firebase CLI (`firebase-tools`) | `npm i -g firebase-tools` | 00 |
...
| 03 | [Firebase provision](./steps/03-firebase-provision.md) | Project + web config | `firebase use` resolves |
